...
'''
✅ 3. One-hot encoding
Transformă sex și embarked în coloane binare:

sex_male (1 = bărbat)

embarked_Q, embarked_S (referință implicită: C)

Folosește drop_first=True → evită multicoliniaritatea.

✅ 4. Min-Max Scaling
Normalizează age, fare și family_size în intervalul [0, 1].

🧠 De ce? Modelele bazate pe distanță sau gradient (ex: regresie logistică, KNN, NN) sunt sensibile la magnitudinea valorilor.'''
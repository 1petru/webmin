...
# Trains a Naive Bayes classifier on both correct and incorrect labels.
...
'''
Model antrenat cu etichete corecte
Acuratețe: 0.75 (75%)

A clasificat corect 3 din 4 emailuri.

Detalii:

Clasa 0 (Ham): Precision 0.67, Recall 1.00 → toate emailurile ham au fost identificate corect.

Clasa 1 (Spam): Precision 1.00, Recall 0.50 → a identificat doar jumătate dintre spamuri, dar fără fals pozitiv.

👉 Concluzie: Modelul învață destul de bine chiar și dintr-un set mic, dar este limitat de dimensiunea datelor.

❌ Model antrenat cu etichete greșite (50% inversate)
Acuratețe: 0.50 (50%)

A ghicit doar 2 din 4 emailuri.

Detalii:

Clasa 0 (Ham): Precision 0.50, Recall 1.00 → toate hamurile au fost detectate, dar jumătate dintre predicții pentru ham au fost greșite.

Clasa 1 (Spam): Precision 0.00, Recall 0.00 → nicio detectare corectă de spam.

👉 Concluzie: Modelul nu a învățat aproape nimic util din etichetele greșite. În realitate, se comportă ca și cum spamul nici nu ar exista.
